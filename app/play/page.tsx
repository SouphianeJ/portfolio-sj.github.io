...
export default function PlayPage(){
  ...
  React.useEffect(()=>{
    const canvas = ref.current!; const c = canvas.getContext('2d')!;
    let w = canvas.width = 720, h = canvas.height = 220;
    let t = 0, speed = 3, jump = 0, y = 160, vy = 0, gravity = 0.6;
    let obstacles: {x:number}[] = [{x: w+100}], score = 0, alive = true;
  ...
  return (
    <main className="p-6 md:p-10 max-w-4xl mx-auto space-y-4">
      ...
      <p className="opacity-80">Runner minimal (barre espace ou ↑ pour sauter). On itèrera ici (achievements, easter eggs, analytics d’engagement).</p>
